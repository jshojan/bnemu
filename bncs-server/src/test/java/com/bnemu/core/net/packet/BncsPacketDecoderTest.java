package com.bnemu.core.net.packet;
...
public class BncsPacketDecoderTest {
    ...
    public void testDecodeValidPacket() {
        ...
        Assertions.assertTrue(channel.writeInbound(buffer), "Failed to write inbound buffer");

        // Read the decoded packet
        BncsPacket decoded = channel.readInbound();
        Assertions.assertNotNull(decoded, "Decoded packet is null");
        ...
        Assertions.assertArrayEquals(expectedPayload, actualPayload, "Payload mismatch");
